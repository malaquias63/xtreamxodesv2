...
if ($Cb08b127bfe426d7f3ccbd3e38f05471['delay_minutes'] == 0 || $Cb08b127bfe426d7f3ccbd3e38f05471['parent_id'] != 0) {
    die;
}
...
while (Cd89785224751ccA8017139daf9E891E::bcAa9b8a7B46eB36Cd507a218Fa64474($e6c7e9118e68c5632594189a4c0f5d47, $ba85d77d367dcebfcc2a3db9e83bb581) && file_exists($Afc586234254c12273d2fecf9c81d7de)) {
    if ($f4cb2e0f4f9d3070cea6104f839ddf0c != $Bdc1c8e2b3e276254f5bac32b7c43966) {
        ...
        if (!empty($E32190558705873b39f90bdb17221fd6['segments'])) {
            ...
            if (preg_match('/.*\\_(.*?)\\.ts/', $E32190558705873b39f90bdb17221fd6['segments'][0]['file'], $ae37877cee3bc97c8cfa6ec5843993ed)) {
